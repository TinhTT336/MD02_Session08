  ...
  return (
    <>
      ...
      <ul style={{ display: "flex" }}>
        <li style={{ textDecoration: "none", listStyle: "none" }}> <NavLink to={"/invoices/:invoiceId"} style={{ textDecoration: "none", listStyle: "none" }}>Invoices</NavLink> </li>
        <li> <NavLink to={"/expenses"} style={{ textDecoration: "none", listStyle: "none" }}>Expenses</NavLink> </li>
      </ul>
