  ...
  return (
    <>
      ...
      <ul style={{ display: "flex" }}>
        <li style={{ listStyle: "none" }}> <NavLink to={"/invoices/:invoiceId"} style={{ textDecoration: "none", listStyle: "none", color: "black" }}>Invoices</NavLink> </li>
        <li> <NavLink to={"/expenses"} style={{ textDecoration: "none", listStyle: "none", color: "black" }}>Expenses</NavLink> </li>
      </ul>
