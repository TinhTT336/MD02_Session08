  ...
  return (
    <>
      ...
      <ul style={{ display: "flex" }}>
        <li style={{ listStyle: "none" }}> <NavLink to={"/invoices/:invoiceId"} style={{ textDecoration: "none", color: "black" }}>Invoices</NavLink> </li>
        <li style={{ listStyle: "none" }}> <NavLink to={"/expenses"} style={{ textDecoration: "none", color: "black" }}>Expenses</NavLink> </li>
      </ul>
